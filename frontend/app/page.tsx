...
const dapps = [
  ...
  },
  {
    ...
    description: "Students learn and mint badges for their achievements.",
    features: ["Record achievements on-chain", "Show the achievements"],
    route: "/mint-badge"
  }
]
